const articles = [{
  'id': 1,
  'photo': require('../img/myanmar-hi-tech.png'),
  'type': 'article',
  'time': -300,
  'header': 'MYANMAR HI TECH PTE LTD',
  'text': 'Myanmar Hi Tech Pte Ltd. (Myanmar Hi Tech) was established in Singapore in 2014 to conduct market survey and promotions in Singapore.',
  'comments': [{
    'id': 1,
  ...
  'id': 2,
  'photo': require('../img/ace-future.png'),
  'type': 'article',
  'time': -1373,
  'header': 'ACE FUTURE',
  'text': 'ACE Future Innovation (AFI) was established in 2015. ' +
  ...
  'id': 3,
  'photo': require('../img/ace-inspiration.png'),
  'type': 'article',
  'time': -2446,
  'header': 'ACE INSPIRATION',
  'text': 'ACE training center was spun-off and formed ACE Inspiration Ltd. ' +
  ...
  'id': 4,
  'photo': require('../img/ace-engineering.png'),
  'type': 'article',
  'time': -3519,
  'header': 'ACE ENGINEERING',
  'text': 'Mitsuiwa-ACE Engineering Ltd. (MAE) in 2016 to provide server integration, network integration and cyber security solutions and services. ' +
  ...
  'id': 5,
  'photo': require('../img/ace-data-consulting.png'),
  'type': 'article',
  'time': -4592,
  'header': 'ACE DATA CONSULTING ',
  ...
  'id': 6,
  'photo': require('../img/ace-data-system.png'),
  'type': 'article',
  'time': -5665,
  'header': 'ACE DATA SYSTEM',
  'text': 'ACE Data Systems Ltd. was founded in 1992 as a small software house and IT training center. ' +
  ...
  'id': 7,
  'photo': require('../img/ace-plus.png'),
  'type': 'fact',
  'time': -5665,
  'header': 'ACE PLUS',
  'text': 'AcePlus Solutions has started in July 2012 as a subsidiary company of ACE Data Systems. ',
  'comments': []
}, {
  'id': 8,
  'photo': require('../img/ace-dat.png'),
  'type': 'fact',
  'time': -8373,
  'header': 'ACE DAT',
  'text': 'Daiwa Institute of Research from Japan formed DIR-ACE Technology Ltd. (DAT) to provide IT solutions for capital market. ',
  'comments': []
}, {
  'id': 9,
  'photo': require('../img/ace-japan.png'),
  'type': 'fact',
  'time': -52365,
  'header': 'ACE JAPAN',
  ...
  'id': 10,
  'photo': require('../img/ace-global-traiding.png'),
  'type': 'fact',
  'time': -1295,
  'header': 'Ace Global Traiding',
  'text': 'You blink over 10,000,000 times a year.',
  'comments': []
}, {
  'id': 11,
  'photo': require('../img/ace-golden-rock.png'),
  'type': 'post',
  'time': -300,
  'title': 'ACE GOLDEN ROCK',
  ...
  'id': 12,
  'photo': require('../img/gmoz-ace.png'),
  'type': 'post',
  'time': -1373,
  'header': 'GMOZ ACE',
  'text': 'In 2014, ACE Data Systems Ltd. and GMO Internet Group from Japan formed GMO Z.com ACE Ltd.',
  'comments': []
},
];
